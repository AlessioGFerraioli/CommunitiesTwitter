...
#%%%% Communities detection with igraph
''' by alessio '''
...
communities = h.community_multilevel(weights=dataframe_weight["weight"])


#%% visualization of communities with igraph
''' by alessio '''
...
# visual_style["edge_color"] = '#50505011'
visual_style["vertex_frame_width"] = 0
visual_style["layout"] = h.layout_fruchterman_reingold(weights=h.es["weight"])
visual_style["bbox"] = (600, 600)
visual_style["margin"] = 20
#plotting to file 
ig.plot(h, "D:/Users/aless/Desktop/Universita/Complex_Networks_Remondini/Twitter_proj/test_plots/ig_remove_small12.png", **visual_style)
